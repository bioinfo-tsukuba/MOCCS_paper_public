TF_graph_2_db <- function(df_p_3, receiver_tf_list){
  ...
  system(paste0("mkdir ~/MOCCS_paper_public/data/Fig2/obj/k_sim_pearson_mat"))
  ...
  for (i in 1:length(receiver_tf_list)){
    ...
    saveRDS(k_sim_2_mat, paste0("~/MOCCS_paper_public/data/Fig2/obj/k_sim_pearson_mat/k_sim_pearson_mat_", at_1, ".rds"))
