...
Fig6C_CL <- df3  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
...
Fig6C_TF <- df3  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
...
Fig6C_CL <- df3  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
  ...
  ggtitle(target_phenotype) +
  coord_flip()
ggsave(paste0("/Users/saeko/Documents/MOCCS/paper_figure/MOCCS-DB_paper/plot/Fig6/Fig6C_", target_phenotype,"_CL_rs.pdf"), Fig6C_CL, width = 7, height = 7)
...
Fig6C_TF <- df3  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
  ...
  ggtitle(target_phenotype) +
  coord_flip()
ggsave(paste0("/Users/saeko/Documents/MOCCS/paper_figure/MOCCS-DB_paper/plot/Fig6/Fig6C_", target_phenotype,"_TF_rs.pdf"), Fig6C_TF, width = 7, height = 7)
...
Fig6C_CL <- df4  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
  ggplot(aes(x = reorder(ID_snp_for_join, max_abs_dMOCCS2score), y = max_abs_dMOCCS2score, fill = Cell_type_class))+
  geom_col() +
  theme(plot.title = element_text(face="bold",hjust = 0.5), 
        panel.grid.major = element_line(colour = "gray"),
  ...
  ggtitle(target_phenotype) +
  coord_flip()
ggsave(paste0("/Users/saeko/Documents/MOCCS/paper_figure/MOCCS-DB_paper/plot/Fig6/Fig6C_", target_phenotype,"_CL_ref_kmer.pdf"), Fig6C_CL, width = 7, height = 7)


Fig6C_TF <- df4  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
  ggplot(aes(x = reorder(ID_snp_for_join, max_abs_dMOCCS2score), y = max_abs_dMOCCS2score, fill = Antigen))+
  geom_col() +
  theme(plot.title = element_text(face="bold",hjust = 0.5), 
        panel.grid.major = element_line(colour = "gray"),
  ...
  ggtitle(target_phenotype) +
  coord_flip()
ggsave(paste0("/Users/saeko/Documents/MOCCS/paper_figure/MOCCS-DB_paper/plot/Fig6/Fig6C_", target_phenotype,"_TF_ref_kmer.pdf"), Fig6C_TF, width = 7, height = 7)
...
Fig6C_CL <- df4  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
  ...
  ggtitle(target_phenotype) +
  coord_flip()
ggsave(paste0("/Users/saeko/Documents/MOCCS/paper_figure/MOCCS-DB_paper/plot/Fig6/Fig6C_", target_phenotype,"_CL_alt_kmer.pdf"), Fig6C_CL, width = 7, height = 7)
...
Fig6C_TF <- df4  %>% unite("ID_snp_for_join", c(ID, snp_for_join)) %>% filter(max_abs_dMOCCS2score > threshold) %>%
  ...
  ggtitle(target_phenotype) +
  coord_flip()
ggsave(paste0("/Users/saeko/Documents/MOCCS/paper_figure/MOCCS-DB_paper/plot/Fig6/Fig6C_", target_phenotype,"_TF_alt_kmer.pdf"), Fig6C_TF, width = 7, height = 7)
