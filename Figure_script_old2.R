...
## Fig. 1F ------
source("~/MOCCS_paper_public/function/Fig1F_plot_v2.R")
target_TF <- "CTCF"
annotation_path <- "~/MOCCS_paper_public/data/Fig1/"
...
## Fig. 1G ------
source("~/MOCCS_paper_public/function/Fig1G_plot_v2.R")
annotation_path <- "~/MOCCS_paper_public/data/Fig1/"
...
### Figure2-3 ###
#################
source("~/MOCCS_paper_public/function/Fig2_3_plot_v2.R")
...
plot(Fig5E[[1]])
plot(Fig5E[[2]])
ggsave(paste0("~/MOCCS_paper_public/plot/Fig5/Fig5E_scatter_", target_TF,".pdf"), Fig5E[[1]], width = 7, height = 7, dpi = 300)
...
plot(labels[[4]])
if(figure == "C"){
  ggsave("~/MOCCS_paper_public/plot/Fig6/CD_SLE_label/SLE_ID.pdf", labels[[1]])
  ...
  ggsave("~/MOCCS_paper_public/plot/Fig6/CD_SLE_label/CD_ID.pdf", labels[[1]])
...
plot(Fig6E[[1]])
plot(Fig6E[[2]])
ggsave(paste0("~/MOCCS_paper_public/plot/Fig6/Fig6E_", target_phenotype,"_CL.pdf"), Fig6E[[1]], width = 14, height = 14)
